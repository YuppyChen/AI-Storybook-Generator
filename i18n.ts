export const translations = {
  en: {
    ...
    imageModelLabel: "Choose an image generation model:",
    numberOfPagesLabel: "Number of pages:",
    pageCountHint: "Enter a number between 1 and 20.",
    styles: {
      storybook: "Storybook",
  ...
  zh: {
    ...
    imageModelLabel: "选择图片生成模型：",
    numberOfPagesLabel: "选择绘本页数：",
    pageCountHint: "请输入 1 到 20 之间的数字。",
    styles: {
      storybook: "绘本风",
      watercolor: "水彩画",
      cartoon: "卡通风",
